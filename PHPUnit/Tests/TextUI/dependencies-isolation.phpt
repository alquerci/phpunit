--TEST--
phpunit --process-isolation --verbose DependencyTestSuite ../Fixtures/DependencyTestSuite.php
--FILE--
<?php
...
$_SERVER['argv'][5] = dirname(dirname(__FILE__)) . '/Fixtures/DependencyTestSuite.php';
