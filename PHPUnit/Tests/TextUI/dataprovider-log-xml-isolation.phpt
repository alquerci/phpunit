--TEST--
phpunit --process-isolation --log-junit php://stdout DataProviderTest ../Fixtures/DataProviderTest.php
--FILE--
<?php
...
$_SERVER['argv'][6] = dirname(dirname(__FILE__)) . '/Fixtures/DataProviderTest.php';
