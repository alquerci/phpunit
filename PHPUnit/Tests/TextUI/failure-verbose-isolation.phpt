--TEST--
phpunit --process-isolation --verbose FailureTest ../Fixtures/FailureTest.php
--FILE--
<?php
...
$_SERVER['argv'][5] = dirname(dirname(__FILE__)) . '/Fixtures/FailureTest.php';
...
PHPUnit_Tests_Fixtures_FailureTest
FFFFFFFFFFFF
